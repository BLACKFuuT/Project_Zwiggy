...
class RestaurantService:
    ...
    async def create_restaurant(
        self, db: AsyncSession, data: RestaurantCreate, owner_id: int
    ):
    ...
    async def get_restaurant(self, db: AsyncSession, restaurant_id: int):
    ...
    async def list_restaurants(self, db: AsyncSession, skip: int, limit: int):
    ...
    async def update_restaurant(
        ...
        return await self.repository.update(
            db, restaurant, data.model_dump(exclude_unset=True)
        )
